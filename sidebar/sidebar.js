// ChatGPT sidebar functionality
document.addEventListener("DOMContentLoaded", function() {
  console.log("ChatGPT sidebar loaded");
  ...
  if (iframe) {
    iframe.addEventListener('load', function() {
      console.log('ChatGPT iframe loaded successfully');
      if (fallback) fallback.classList.remove('show');
    });
    
    iframe.addEventListener('error', function(event) {
      console.error('ChatGPT iframe failed to load:', event);
